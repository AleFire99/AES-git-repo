...
model Plant_heater_with_control_PIFull
  ...
  AES.ProcessComponents.Thermal.Liquid.Tube tubeh2(L = 50) annotation(
    Placement(visible = true, transformation(origin = {288, -94}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
  AES.ProcessComponents.Thermal.Liquid.Tube tubec1(L = 50) annotation(
    Placement(visible = true, transformation(origin = {306, -156}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  ...
  AES.ProcessComponents.Thermal.Liquid.Tube h2(L = 50) annotation(
    Placement(visible = true, transformation(origin = {532, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  AES.ProcessComponents.Thermal.Liquid.Tube closure(L = 1000) annotation(
    Placement(visible = true, transformation(origin = {548, -126}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
  AES.ProcessComponents.Thermal.Liquid.Tube tubeheat annotation(
    Placement(visible = true, transformation(origin = {-148, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  AES.ProcessComponents.Thermal.Liquid.surfQcond_prescribed Qheat annotation(
    Placement(visible = true, transformation(origin = {-208, -102}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  Modelica.Thermal.HeatTransfer.Components.HeatCapacitor Cz2(C = 1e4, T(displayUnit = "K", fixed = true)) annotation(
    Placement(visible = true, transformation(origin = {554, 100}, extent = {{-20, -20}, {20, 20}}, rotation = -90)));
  ...
  Modelica.Blocks.Sources.RealExpression Pressure_difference(y = 2.027 * 10 ^ 5) annotation(
    Placement(visible = true, transformation(origin = {-337, -54}, extent = {{-25, -18}, {25, 18}}, rotation = 0)));
  ...
  Modelica.Blocks.Math.Gain gain(k = 10000) annotation(
    Placement(visible = true, transformation(origin = {-252, -102}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
  AES.ControlBlocks.AnalogueControllers.PI_awfb_basic PI_Heater(CSmax = 1, CSmin = 0, K = 8.2877, Ti = 1.1446 * 10 ^ 3) annotation(
    Placement(visible = true, transformation(origin = {-280, -102}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.RealExpression Heater_T_Max(y = 45 + 273.15) annotation(
    Placement(visible = true, transformation(origin = {-357, -96}, extent = {{-25, -18}, {25, 18}}, rotation = 0)));
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full pI_z1N(CSmax = 1, CSmin = 0, K = 0.07692, Ti = 76.92, hasTracking = true) annotation(
    Placement(visible = true, transformation(origin = {-78, 6}, extent = {{-10, -20}, {10, 20}}, rotation = 0)));
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_full pI_z1D(CSmax = 2, CSmin = 0, K = 0.07692, Ti = 76.92, hasTracking = true) annotation(
    Placement(visible = true, transformation(origin = {-50, 112}, extent = {{-10, -20}, {10, 20}}, rotation = 0)));
  Modelica.Blocks.Sources.CombiTimeTable sp_Tz(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic, offset = {273.15}, smoothness = Modelica.Blocks.Types.Smoothness.LinearSegments, table = [0, 7; 7, 7; 8, 20; 17, 20; 20, 14; 22, 10; 24, 10], timeScale = 3600) annotation(
    Placement(visible = true, transformation(origin = {-198, 136}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
equation
  ...
  connect(tubeh1.pwh_b, tubeh2.pwh_a) annotation(
    Line(points = {{38, -92}, {147, -92}, {147, -94}, {276, -94}}, color = {46, 52, 54}));
  connect(tubeh2.pwh_b, vh2.pwh_a) annotation(
    Line(points = {{300, -94}, {460, -94}, {460, 8}}, color = {46, 52, 54}));
  connect(vh2.pwh_b, h2.pwh_a) annotation(
    Line(points = {{460, 32}, {460, 36}, {520, 36}}, color = {46, 52, 54}));
  connect(tubec1.pwh_b, tubec2.pwh_a) annotation(
    Line(points = {{294, -156}, {174, -156}, {174, -154}, {74, -154}}, color = {46, 52, 54}));
  connect(h2.pwh_b, tubec1.pwh_a) annotation(
    Line(points = {{544, 36}, {544, -156}, {318, -156}}, color = {46, 52, 54}));
  ...
  connect(tubeh2.pwh_b, closure.pwh_a) annotation(
    Line(points = {{300, -94}, {548, -94}, {548, -114}}, color = {46, 52, 54}));
  connect(closure.pwh_b, tubec1.pwh_a) annotation(
    Line(points = {{548, -138}, {548, -156}, {318, -156}}, color = {46, 52, 54}));
  connect(tubeheat.pwh_b, pump.pwh_a) annotation(
    Line(points = {{-148, -98}, {-148, -92}, {-36, -92}}, color = {46, 52, 54}));
  connect(pressuriser.pwh_a, tubeheat.pwh_a) annotation(
    Line(points = {{-36, -154}, {-148, -154}, {-148, -122}}, color = {46, 52, 54}));
  ...
  connect(sTh.pwh_a, tubeheat.pwh_b) annotation(
    Line(points = {{-164, -92}, {-148, -92}, {-148, -98}}, color = {46, 52, 54}));
  connect(Qheat.surf, tubeheat.surf) annotation(
    Line(points = {{-208, -110.667}, {-154, -110.667}, {-154, -109.667}, {-153, -109.667}}, color = {144, 5, 5}));
  ...
  connect(h2.surf, convz2.vectorHP) annotation(
    Line(points = {{532, 41.4}, {532, 52.3}, {530, 52.3}, {530, 62.4}}, color = {144, 5, 5}));
  connect(convz2.HP, Cz2.port) annotation(
    Line(points = {{530, 70}, {530, 100}, {534, 100}}, color = {191, 0, 0}));
  connect(Cz2.port, Hsupz2.port) annotation(
    Line(points = {{534, 100}, {510, 100}, {510, 86}}, color = {191, 0, 0}));
  connect(sTz2.port, Cz2.port) annotation(
    Line(points = {{458, 100}, {534, 100}}, color = {191, 0, 0}));
  connect(thermalConductor.port_b, Cz2.port) annotation(
    Line(points = {{524, 120}, {524, 100}, {534, 100}}, color = {191, 0, 0}));
  connect(gain.y, Qheat.Q) annotation(
    Line(points = {{-247.6, -102}, {-215.6, -102}}, color = {0, 0, 127}));
  connect(Heater_T_Max.y, PI_Heater.SP) annotation(
    Line(points = {{-329.5, -96}, {-292, -96}}, color = {0, 0, 127}));
  connect(PI_Heater.CS, gain.u) annotation(
    Line(points = {{-268, -102}, {-257, -102}}, color = {0, 0, 127}));
  connect(sTh.oT, PI_Heater.PV) annotation(
    Line(points = {{-174, -92}, {-314, -92}, {-314, -106}, {-292, -106}}, color = {0, 0, 127}));
  ...
  connect(Pressure_difference.y, PI_Pressure.SP) annotation(
    Line(points = {{-309.5, -54}, {-188.5, -54}, {-188.5, -56}, {-117.5, -56}}, color = {0, 0, 127}));
  ...
  connect(switch2.y, pI_z2N.TR) annotation(
    Line(points = {{391, 74}, {395, 74}, {395, -38}, {263, -38}, {263, -2}, {316, -2}}, color = {0, 0, 127}));
  ...
  connect(switch4.y, pI_z1N.TR) annotation(
    Line(points = {{23, 68}, {33, 68}, {33, -24}, {-159, -24}, {-159, 8}, {-88, 8}}, color = {0, 0, 127}));
  ...
  connect(pI_z1N.CS, switch4.u3) annotation(
    Line(points = {{-68, 20}, {-16, 20}, {-16, 60}, {0, 60}}, color = {0, 0, 127}));
  connect(LO_limit.y, pI_z2N.SP) annotation(
    Line(points = {{-43, 48}, {232, 48}, {232, 10}, {316, 10}}, color = {0, 0, 127}));
  connect(LO_limit.y, pI_z1N.SP) annotation(
    Line(points = {{-43, 48}, {-111, 48}, {-111, 20}, {-88, 20}}, color = {0, 0, 127}));
  connect(sTz1.T, pI_z1N.PV) annotation(
    Line(points = {{84, 86}, {-134, 86}, {-134, 16}, {-88, 16}}, color = {0, 0, 127}));
  connect(not1.y, pI_z1D.TS) annotation(
    Line(points = {{-72, 209}, {-72, 118}, {-60, 118}}, color = {255, 0, 255}));
  connect(switch4.y, pI_z1D.TR) annotation(
    Line(points = {{23, 68}, {33, 68}, {33, -24}, {-159, -24}, {-159, 114}, {-60, 114}}, color = {0, 0, 127}));
  connect(pI_z1D.CS, switch4.u1) annotation(
    Line(points = {{-40, 126}, {-10, 126}, {-10, 76}, {0, 76}}, color = {0, 0, 127}));
  connect(sTz1.T, pI_z1D.PV) annotation(
    Line(points = {{84, 86}, {-134, 86}, {-134, 122}, {-60, 122}}, color = {0, 0, 127}));
  connect(sp_Tz.y[1], pI_z2D.SP) annotation(
    Line(points = {{-187, 136}, {312, 136}, {312, 140}}, color = {0, 0, 127}));
  connect(sp_Tz.y[1], pI_z1D.SP) annotation(
    Line(points = {{-187, 136}, {-123, 136}, {-123, 126}, {-60, 126}}, color = {0, 0, 127}));
  ...
  connect(greaterThreshold.y, pI_z1N.TS) annotation(
    Line(points = {{-150, 234}, {-98, 234}, {-98, 12}, {-88, 12}}, color = {255, 0, 255}));
  ...
  connect(switch2.y, pI_z2D.TR) annotation(
    Line(points = {{392, 74}, {394, 74}, {394, -38}, {262, -38}, {262, 128}, {312, 128}}, color = {0, 0, 127}));
  annotation(
...
end Plant_heater_with_control_PIFull;
