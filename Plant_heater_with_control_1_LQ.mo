...
model Plant_heater_with_control_1_LQ
  ...
  Modelica.Blocks.Math.Gain Psupz1(k = 500) annotation(
    Placement(visible = true, transformation(origin = {118, 44}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
...
<<<<<<< HEAD
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_basic PI_Pressure(CSmax = 1, CSmin = 0, K = 0.001, Ti = 10000)  annotation(
...
<<<<<<< HEAD
  AES.ControlBlocks.AnalogueControllers.PI_awfb_basic PI_Heater_Hi(CSmax = 1, CSmin = 0, K = 0.0047, Ti = 39.2699) annotation(
    Placement(visible = true, transformation(origin = {-346, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
=======
...
>>>>>>> origin/main
 ...
 Modelica.Blocks.Math.Gain K_heat_z1(k = -0.0011) annotation(
    Placement(visible = true, transformation(origin = {82, 44}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
 Modelica.Blocks.Math.Gain K_valve_z1(k = -9.9822) annotation(
    Placement(visible = true, transformation(origin = {82, 26}, extent = {{-4, -4}, {4, 4}}, rotation = 0)));
 ...
 Modelica.Blocks.Sources.CombiTimeTable sp_Tz2(extrapolation = Modelica.Blocks.Types.Extrapolation.Periodic, offset = {273.15}, smoothness = Modelica.Blocks.Types.Smoothness.LinearSegments, table = [0, 7; 7, 7; 8, 20; 17, 20; 20, 14; 22, 10; 24, 10], timeScale = 3600) annotation(
    Placement(visible = true, transformation(origin = {246, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
<<<<<<< HEAD
...
equation
  ...
  connect(Psupz1.y, Hsupz1.Q_flow) annotation(
    Line(points = {{122, 44}, {122, 56.4}}, color = {0, 0, 127}));
...
<<<<<<< HEAD
  connect(sTh.oT, PI_Heater_Hi.PV) annotation(
    Line(points = {{-174, -4}, {-390, -4}, {-390, -44}, {-358, -44}}, color = {0, 0, 127}));
  connect(P_Loss.y, E_loss.u) annotation(
    Line(points = {{-380.1, 138}, {-313.1, 138}}, color = {0, 0, 127}));
  connect(sTz1.T, K_heat_z1.u) annotation(
    Line(points = {{80, 86}, {62, 86}, {62, 44}, {78, 44}}, color = {0, 0, 127}));
  connect(K_heat_z1.y, Psupz1.u) annotation(
    Line(points = {{86, 44}, {114, 44}}, color = {0, 0, 127}));
  connect(sTz1.T, K_valve_z1.u) annotation(
    Line(points = {{80, 86}, {62, 86}, {62, 26}, {77, 26}}, color = {0, 0, 127}));
  connect(K_valve_z1.y, vh1.x) annotation(
    Line(points = {{86, 26}, {132, 26}}, color = {0, 0, 127}));
  connect(sp_Tz2.y[1], PI_z2.SP) annotation(
    Line(points = {{258, 58}, {294, 58}}, color = {0, 0, 127}));
 connect(PI_Heater_Hi.CS, gain.u) annotation(
    Line(points = {{-334, -40}, {-216, -40}}, color = {0, 0, 127}));
 connect(Heater_T_Max.y, PI_Heater_Hi.SP) annotation(
    Line(points = {{-416, -34}, {-358, -34}}, color = {0, 0, 127}));
=======
