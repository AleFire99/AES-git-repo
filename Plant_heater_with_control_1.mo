...
model Plant_heater_with_control_1
  ...
  AES.ControlBlocks.AnalogueControllers.PI_awfb_basic PI_Heater(CSmax = 1, CSmin = 0, K = 1, Ti = 39.2699) annotation(
...
equation
  ...
  connect(PI_Pressure.PV, sDp.oDp) annotation(
    Line(points = {{-6, 50}, {-52, 50}, {-52, -38.4}}, color = {0, 0, 127}));
  connect(sTz2.T, PI_z2.PV) annotation(
    Line(points = {{282, 88}, {282, 47}, {292, 47}, {292, 48}}, color = {0, 0, 127}));
  ...
  connect(PI_Heater.CS, gain.u) annotation(
    Line(points = {{-298, -40}, {-229, -40}}, color = {0, 0, 127}));
  connect(sTh.oT, PI_Heater.PV) annotation(
    Line(points = {{-174, -4}, {-394, -4}, {-394, -44}, {-322, -44}}, color = {0, 0, 127}));
